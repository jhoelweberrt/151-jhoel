...
let chances = 10 // Quantas chanches o jogador vai ter para tentar acertar
let tentativas = 1 
...
function jogada(){
    ...
    if (palpite == magico) {
        resp.innerHTML = ` &#x2705; PARABÉNS! Você acaba de o número! Eu realmente tinha pensado no valor ${magico}. Você acertou depois de ${tentativas} tentativa(s)! &#x1F44F; `
